--@03/02/2018
--Made by Estebouboun (http://steamcommunity.com/id/esteboubounsmurf)
...
function PANEL:AddTab(name, icon, child)
	...
	b.Paint = function(self, w, h)
		...
		self.alpha = Lerp(FrameTime() * 3, self.alpha, toAlpha)
...
styles.Player = function(pnl)
	...
	pnl.PaintOver = function(self, w, h)
		draw.SimpleText(pnl.Name, font, h, h / 2, pnl.TextClr, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end
end
...
styles.Entity = function(pnl)
	...
	pnl.PaintOver = function(self, w, h)
		...
		draw.SimpleText(pnl.Name, font, h + 6, h / 2, self.TextClr, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end
end

styles.String = function(pnl)
	pnl.PaintOver = function(self, w, h)
		draw.SimpleText(pnl.String, font, w / 2, h / 2, self.TextClr, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end
