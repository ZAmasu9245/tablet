local APP = {}
APP.ID = "speedy"
APP.Name = "Speedy Browser"
APP.Icon = Material("ugc/tablet/speedy.png", "smooth")
APP.SortOrder = 100
...
function APP:onOpen(layout, frame)
	layout.Paint = function(self, w, h)
		...
		ui.DrawText("Loading...", "tabletspeedy_loading", w / 2, h / 2, Color(120, 120, 120), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
	...
	html_pnl:OpenURL("https://google.com")
	...
	header.AddressBar:SetText("https://google.com")
end
